...
'for sharing his change screen resolution module...

' It helped a lot in my project Zion Library design....
...
Public OldX As Integer, OldY As Integer, OldColor As Integer, OldFreq As Integer
Public SetX As Integer, SetY As Integer, SetColor As Integer, SetFreq As Integer
